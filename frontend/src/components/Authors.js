...
const Authors = ({show, authors, setError, user}) => {
    ...
    <div>
      ...
      <Card color="transparent" className="h-full w-full overflow-scroll flex items-center" shadow={false}>
        ...
        <Typography color="gray" className="mt-1 font-normal">
          {user? '---- Select a author to update the birthday ----' : '---- Please log in to update the author\'s birthyear ----'}
        </Typography>
            {user? (<form onSubmit={submit} className="mt-8 mb-2 w-80 max-w-screen-lg sm:w-96">
